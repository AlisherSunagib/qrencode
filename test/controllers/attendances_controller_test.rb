...
class AttendancesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create attendance" do
    assert_difference('Attendance.count') do
      post attendances_url, params: { attendance: { date: @attendance.date, status: @attendance.status, studid: @attendance.studid } }
    end
  ...
  test "should update attendance" do
    patch attendance_url(@attendance), params: { attendance: { date: @attendance.date, status: @attendance.status, studid: @attendance.studid } }
